...
export class GameScene3 extends BaseScene {
    ...
    createOverlays() {
        ...
        this.textA = this.add.text(250 * 3.5, this.cameras.main.height / 2, decryptN('44'), { font: "normal 60px MyCustomFont", fill: '#000000', align: 'center' }).setScrollFactor(0).setDepth(2);
