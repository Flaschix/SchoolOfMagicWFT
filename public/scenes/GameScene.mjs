...
export class GameScene extends Phaser.Scene {
    ...
    createUnWalkedObjects() {
        // const body5 = this.matter.add.fromVertices(465, 930, '458.5 105.5 24 105.5 1.5 66.5 6 24.5 43.5 0.5 424.5 0.5 483.5 43.5 483.5 77.5', { isStatic: true }, true);
        ...
        // const bodyBookshellRightDown2 = this.matter.add.fromVertices(1536 + 124, 1671 + 90, '244.5 1 0.5 1 0.5 184 244.5 184', { isStatic: true }, true)
        // const bodyBookshellRightDown1 = this.matter.add.fromVertices(1536 + 118, 1470 + 74, '235 1 1 1 1 148 235 148', { isStatic: true }, true)
        // const bodyTableMiddleRight = this.matter.add.fromVertices(1285 + 98, 1333 + 94, '12.5 1 1 28.5 1 319 9.5 330.5 162.5 325.5 176 245 169.5 65 162.5 47.5 169.5 21.5 157 1', { isStatic: true }, true)
        // const bodyTableTopRight = this.matter.add.fromVertices(1614 + 70, 780 + 45, '136.5 1 1 1 1 85 145 76.2093', { isStatic: true }, true)
        // const bodyBookshellRightTop = this.matter.add.fromVertices(1509 + 160, 416 + 90, '332.5 272 1 272 1 34.5 63.5 28 69.5 0.5 258.5 0.5 258.5 28 332.5 28', { isStatic: true }, true)
        // // const bodyDoor = this.matter.add.fromVertices(942 + 86, 483 + 90, '167.5 0.5 1 0.5 1 176 167.5 176', { isStatic: true }, true)
        // const bodyBookshellLeftTop = this.matter.add.fromVertices(212 + 184, 424 + 86, '70.5 36 5.5 36 0.5 328 339 328 339 40 270 32.5 261.5 1 70.5 1', { isStatic: true }, true)
        // const bodyTableMiddleLeft = this.matter.add.fromVertices(154 + 55, 1090 + 98, '95 0.5 17 0.5 0.5 35.5 3.5 188.5 110 188.5 110 42.5', { isStatic: true }, true)
        // const bodyTableMiddleLeft2 = this.matter.add.fromVertices(625 + 80, 1330 + 165, '1 327 163.5 327 169.5 163.5 160 1 79 1 12 1 1 17.5', { isStatic: true }, true)
        // const bodyBookshellLeftDown2 = this.matter.add.fromVertices(283 + 116, 1672 + 90, '231 1 1 1 1 171 231 171', { isStatic: true }, true)
        // const bodyBookshellLeftDown1 = this.matter.add.fromVertices(279 + 116, 1467 + 70, '232 1 1 1 1 152 232 152', { isStatic: true }, true)
    }
    ...
    createCollision() {
        ...
        const bodyBookshellRightTop = this.matter.add.fromVertices(1509 + 162, 416 + 150, `
            1 272 
            1 34 
            63 28 
            258 28 
            332 28
            332 272 
            `, { label: '1', isStatic: true })
        const bodyBookshellLeftTop = this.matter.add.fromVertices(212 + 184, 424 + 86, '70 36 5 36 1 328 339 328 339 40 270 32 261 1 70 1', { label: '1', isStatic: true })
        ...
        const bodyBookshellLeftDown1 = this.matter.add.fromVertices(279 + 116, 1467 + 70, '232 1 1 1 1 152 232 152', { label: '2', isStatic: true })
